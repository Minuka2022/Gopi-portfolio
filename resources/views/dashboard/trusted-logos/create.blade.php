        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Add New Trusted Logo</h4>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="file" name="logo_image" id="logo_image" class="form-control-file" required>
                                    <small class="text-muted">Recommended size: 200x100 pixels. Transparent PNG preferred.</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="form-group">
