...
<head>
    ...
    <title>Gopi Muthumaran - Events</title>
                                ...
                                <div class="event-card">
                                    ...
                                    <div class="event-image-container">
                                        <a href="{{ route('events.show', ['slug' => Str::slug($event->title) . '-' . $event->id]) }}">
                                            <img class="event-image" src="{{ asset('storage/' . ($event->eventImages->first()->image ?? 'default.jpg')) }}" alt="{{ $event->title }}">
                                        </a>
                                    ...
                                    <div class="event-content">
                                        <div class="event-meta">
                                            <span class="event-date">
                                                <i class="far fa-calendar-alt"></i> {{ $event->created_at->format('F d, Y') }}
                                            </span>
