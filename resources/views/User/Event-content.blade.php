...
<head>
    ...
    <meta name="keywords" content="portfolio, personal, event">
...
<body>
    <div id="dtr-wrapper" class="clearfix">
        ...
        <!-- Page content starts -->
        <section class="event-detail-section" style="background-color:white; padding-top: 120px;">
            <div class="container">
                <!-- Main Page Title -->
                <div class="page-title-container">
                    <h1 class="page-title">{{ $event->title }}</h1>
                    <a href="{{ route('frontend-event') }}" class="back-to-events-btn">BACK TO EVENTS</a>
                </div>
                
                <!-- Event Meta Info -->
                <div class="event-meta">
                    <span class="event-date"><i class="fas fa-calendar-alt"></i> {{ $event->created_at->format('F d, Y') }}</span>
                </div>
                        ...
                        <div class="swiper mySwiper">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide">
                                    <img src="{{ asset('storage/' . $image->image) }}" alt="Event Image" class="gallery-image">
                                </div>
                                @endforeach
                            </div>
                            <!-- Navigation -->
