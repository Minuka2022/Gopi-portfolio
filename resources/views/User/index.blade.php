            ...
            <section class="dtr-section padding-y-100 " id="client">
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="dtr-intro width-50-center-align">
                                <h2 class="dtr-intro__heading" style="color: black;">My Clients</h2>
                                <p style="color: black"><b>Proud to have collaborated with renowned organizations, delivering tailored solutions that drive success and lasting partnerships.</b></p>
                            </div>
                        </div>
                    </div>
                    <!--== intro ends ==-->
                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <!-- client box starts -->
                            <div class="dtr-client-box mobile-bg-4 " style="background-color: #003366;">
                                ...
                                <!-- <div class="dtr-client-box__hover-content" style="background-color: #4E749B;">
                                    <h5 class="dtr-client-box__heading">Danshur</h5>
                            ...
                            <!-- client box starts -->
                            <div class="dtr-client-box dtr-client-box--clr-scheme2 mobile-bg-3" style="background-color:#4E749B;">
                                <div class="dtr-client-box__content">
                                    <img src="assets/images/client-5.png" alt="client-5">
                                </div>
                                <!-- <div class="dtr-client-box__hover-content" style="background-color: #003366;">
                                    <h5 class="dtr-client-box__heading">Validus</h5>
                                    <div class="dtr-client-box__text">Lorem ipsum dolor sit amet consectetur adipiscing labore et dolore magna aliqua.</div>
                                    <a href="#" class="dtr-client-box__link" role="button" aria-label="Read More"></a>
                                </div> -->
                            </div>
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <!-- client box starts -->
                            <div class="dtr-client-box dtr-client-box--clr-scheme2 mobile-bg-4" style="background-color:#4E749B;">
                                <div class="dtr-client-box__content">
                                    <img src="assets/images/client-2.png" alt="client-2">
                                </div>
                                <!-- <div class="dtr-client-box__hover-content" style="background-color:#003366">
                                    <h5 class="dtr-client-box__heading">Aumn</h5>
                                    <div class="dtr-client-box__text">Lorem ipsum dolor sit amet consectetur adipiscing labore et dolore magna aliqua. </div>
                                    <a href="#" class="dtr-client-box__link" role="button" aria-label="Read More"></a>
                                </div> -->
                            </div>
                            ...
                            <!-- client box starts -->
                            <div class="dtr-client-box mobile-bg-3" style="background-color:#003366;">
                                <div class="dtr-client-box__content">
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <div class="dtr-client-box mobile-bg-4" style="background-color: #003366;">
                                ...
                                <!-- <div class="dtr-client-box__hover-content" style="background-color: #4E749B;">
                                    <h5 class="dtr-client-box__heading">Muw</h5>
                                    <div class="dtr-client-box__text">Lorem ipsum dolor sit amet consectetur adipiscing labore et dolore magna aliqua. </div>
                                    <a href="#" class="dtr-client-box__link" role="button" aria-label="Read More"></a>
                                </div> -->
                            </div>
                            ...
                            <div class="dtr-client-box dtr-client-box--clr-scheme2 mobile-bg-3" style="background-color: #4E749B;">
                                ...
                                <!-- <div class="dtr-client-box__hover-content" style="background-color:#003366;">
                                    <h5 class="dtr-client-box__heading">Ministry of Motion</h5>
                                    <div class="dtr-client-box__text">Lorem ipsum dolor sit amet consectetur adipiscing labore et dolore magna aliqua. </div>
                                    <a href="#" class="dtr-client-box__link" role="button" aria-label="Read More"></a>
                                </div> -->
                            </div>
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <div class="dtr-client-box dtr-client-box--clr-scheme2 mobile-bg-4" style="background-color: #4E749B;">
                                ...
                                <!-- <div class="dtr-client-box__hover-content" style="background-color: #003366;">
                                    <h5 class="dtr-client-box__heading">Hive</h5>
                                    <div class="dtr-client-box__text">Lorem ipsum dolor sit amet consectetur adipiscing labore et dolore magna aliqua. </div>
                                    <a href="#" class="dtr-client-box__link" role="button" aria-label="Read More"></a>
                                </div> -->
                            </div>
                            ...
                            <div class="dtr-client-box mobile-bg-3" style="background-color:#003366;">
                                ...
                                <!-- <div class="dtr-client-box__hover-content" style="background-color: #4E749B;">
                                    <h5 class="dtr-client-box__heading">Penguin Looks</h5>
                                    <div class="dtr-client-box__text">Lorem ipsum dolor sit amet consectetur adipiscing labore et dolore magna aliqua. </div>
                                    <a href="#" class="dtr-client-box__link" role="button" aria-label="Read More"></a>
                                </div> -->
                            </div>
