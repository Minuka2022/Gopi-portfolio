            ...
            <div class="container">
               <div class="page-inner">
                  ...
                  <div class="col-md-12">
                     <div class="card">
                        <div class="card-body">
                            <form id="eventForm" action="{{ route('Dashboard-Store-Event') }}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mb-3">
                                    <label class="form-label">Event Description <small>(max 20 words)</small></label>
                                    ...
                                    imageInput.addEventListener('change', function () {
                                        Array.from(imageInput.files).forEach(file => {
                                            if (file.type.startsWith('image/')) {
                                                ...
                                                fetch('{{ route("Dashboard-Upload-EImage") }}', {
                                                    method: 'POST',
                                                    headers: {
