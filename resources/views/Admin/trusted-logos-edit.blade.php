...
<head>
    ...
    <!-- Demo CSS (only for preview/testing) -->
            ...
            <div class="container">
               <div class="page-inner">
                  <div class="page-header">
                     <h3 class="fw-bold mb-3">Edit Trusted Logo</h3>
                        ...
                        <div class="card">
                           ...
                           <div class="card-body">
                              <form action="{{ route('Dashboard-Update-TrustedLogo', $trustedLogo->id) }}" method="POST" enctype="multipart/form-data">
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control @error('company_name') is-invalid @enderror" id="company_name" name="company_name" value="{{ old('company_name', $trustedLogo->company_name) }}" required>
                                          @error('company_name')
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="number" class="form-control @error('display_order') is-invalid @enderror" id="display_order" name="display_order" value="{{ old('display_order', $trustedLogo->display_order) }}">
                                          @error('display_order')
                                             <div class="invalid-feedback">{{ $message }}</div>
                                          @enderror
                                       </div>
                                 ...
                                 <div class="row">
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <input type="url" class="form-control @error('website_url') is-invalid @enderror" id="website_url" name="website_url" value="{{ old('website_url', $trustedLogo->website_url) }}" placeholder="https://example.com">
                                          @error('website_url')
                                             <div class="invalid-feedback">{{ $message }}</div>
                                          @enderror
                                       </div>
                                    ...
                                    <div class="col-md-6">
                                       <div class="form-group">
                                          ...
                                          <select class="form-control @error('is_active') is-invalid @enderror" id="is_active" name="is_active">
                                             <option value="1" {{ old('is_active', $trustedLogo->is_active) == 1 ? 'selected' : '' }}>Active</option>
                                             <option value="0" {{ old('is_active', $trustedLogo->is_active) == 0 ? 'selected' : '' }}>Inactive</option>
                                          </select>
                                          @error('is_active')
                                             <div class="invalid-feedback">{{ $message }}</div>
                                          @enderror
                                 ...
                                 <div class="row">
                                    <div class="col-md-12">
                                       <div class="form-group">
                                          ...
                                          <div class="mt-2">
                                             <p>Current Logo:</p>
                                             <img src="{{ asset($trustedLogo->logo_image) }}" alt="{{ $trustedLogo->company_name }}" height="80" class="img-thumbnail">
                                          </div>
                                          @endif
                                       </div>
                                    </div>
                                 ...
                                 <div class="row mt-4">
                                    <div class="col-md-12">
                                       <button type="submit" class="btn btn-primary">Update Trusted Logo</button>
